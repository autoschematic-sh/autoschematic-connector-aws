...
pub struct VpcConnectorConfig {
    pub enabled_regions: Vec<String>,
}

impl Default for VpcConnectorConfig {
    fn default() -> Self {
        Self {
            enabled_regions: vec![
                // "af-south-1",
...
impl VpcConnectorConfig {
    pub fn try_load(prefix: &Path) -> anyhow::Result<Option<VpcConnectorConfig>> {
        let config_path = prefix.join("aws/vpc/config.ron");
